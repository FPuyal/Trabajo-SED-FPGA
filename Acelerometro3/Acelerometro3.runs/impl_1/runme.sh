...
HD_PWD='C:/Users/carlo/Desktop/Trabajo-SED-FPGA/Acelerometro3/Acelerometro3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AccelerometerCtl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AccelerometerCtl.tcl -notrace
