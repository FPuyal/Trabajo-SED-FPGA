...
#
# Script generated by Vivado on Tue Dec 03 12:24:04 +0100 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : AccelerometerCtl.sh
...
#
# Usage        : AccelerometerCtl.sh
#                AccelerometerCtl.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                AccelerometerCtl.sh [-reset_run]
#                AccelerometerCtl.sh [-reset_log]
#                AccelerometerCtl.sh [-help]
#
...
#                script (type 'AccelerometerCtl.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_13 -libname c_reg_fd_v12_0_9 -libname xbip_dsp48_wrapper_v3_0_6 -libname xbip_pipe_v3_0_9 -libname xbip_dsp48_addsub_v3_0_9 -libname xbip_addsub_v3_0_9 -libname c_addsub_v12_0_18 -libname xbip_bram18k_v3_0_9 -libname mult_gen_v12_0_21 -libname axi_utils_v2_0_9 -libname cordic_v6_0_22 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_13 c_reg_fd_v12_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_pipe_v3_0_9 xbip_dsp48_addsub_v3_0_9 xbip_addsub_v3_0_9 c_addsub_v12_0_18 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 axi_utils_v2_0_9 cordic_v6_0_22 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "AccelerometerCtl.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./AccelerometerCtl.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.AccelerometerCtl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.AccelerometerCtl -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log AccelerometerCtl_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./AccelerometerCtl.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: AccelerometerCtl.sh [-help]\n\
Usage: AccelerometerCtl.sh [-step]\n\
Usage: AccelerometerCtl.sh [-lib_map_path]\n\
Usage: AccelerometerCtl.sh [-reset_run]\n\
Usage: AccelerometerCtl.sh [-reset_log]\n\
Usage: AccelerometerCtl.sh [-keep_index]\n\
Usage: AccelerometerCtl.sh [-noclean_files]\n\n\
