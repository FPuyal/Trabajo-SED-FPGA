...
design_libs=(xbip_utils_v3_0_13 c_reg_fd_v12_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_pipe_v3_0_9 xbip_dsp48_addsub_v3_0_9 xbip_addsub_v3_0_9 c_addsub_v12_0_18 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 axi_utils_v2_0_9 cordic_v6_0_22 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.AccelerometerCtl -o AccelerometerCtl_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./AccelerometerCtl_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key AccelerometerCtl_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc AccelerometerCtl_simv.daidir vcs_lib c.obj)
