...
HD_PWD='C:/Users/fpuya/SED/Trabajo-SED-FPGA/Trabajo-FPGA/Trabajo-FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AccelerometerCtl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AccelerometerCtl.tcl
