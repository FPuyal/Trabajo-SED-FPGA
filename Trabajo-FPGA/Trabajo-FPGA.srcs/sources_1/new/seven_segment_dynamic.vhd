...
architecture Behavioral of seven_segment_dynamic is
    ...
    signal dp_output       : STD_LOGIC := '0';                        -- Control del punto decimal
...
begin
    ...
    begin
        ...
        case current_display is
            when "000" => -- Display A7: Signo
                an <= "01111111"; -- Activar A7 (lógica inversa: 0 activa el display)
                if sign = '1' then
                    segment_output <= "0000001"; -- Muestra "-"
                else
                    segment_output <= "1111111"; -- Apagado
                end if;
                dp_output <= '0'; -- Punto decimal apagado

            when "001" => -- Display A6: Centenas
                an <= "10111111"; -- Activar A6
                segment_output <= decoded_centena;
                dp_output <= '0'; -- Punto decimal apagado

            when "010" => -- Display A5: Decenas
                an <= "11011111"; -- Activar A5
                segment_output <= decoded_decena;
                dp_output <= '0'; -- Punto decimal apagado

            when "011" => -- Display A4: Unidades
                an <= "11101111"; -- Activar A4
                segment_output <= decoded_unidad;
                dp_output <= '1'; -- Punto decimal activo

            when "100" => -- Display A3: Décimas
            ...
            when others =>
                ...
                dp_output <= '0'; -- Apagar punto decimal
        end case;
    end process;
