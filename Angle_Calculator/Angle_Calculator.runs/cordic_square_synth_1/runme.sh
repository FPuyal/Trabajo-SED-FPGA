...
HD_PWD='C:/Users/skstu/Documents/GitHub/Trabajo-SED-FPGA/Angle_Calculator/Angle_Calculator.runs/cordic_square_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_square.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cordic_square.tcl
